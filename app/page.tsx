    ...
    <div className="flex-1">
      ...
      <header className="relative overflow-hidden border-b border-glass-border bg-gradient-to-b from-background/50 to-transparent">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-1/2 top-0 -translate-x-1/2 h-[300px] w-[600px] rounded-full bg-accent/[0.07] blur-[100px]" />
        </div>

        <div className="relative mx-auto max-w-7xl px-6 py-14 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent/10 px-4 py-1.5 text-[10px] md:text-xs font-medium text-accent mb-5">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm md:text-base leading-relaxed text-muted">
    ...
    <div className="flex flex-col items-center justify-center py-28 text-center">
      ...
      <div
        className="mb-6 flex h-20 w-20 items-center justify-center rounded-2xl
                    bg-background/80 ring-1 ring-white/[0.06]
      ...
      <p className="mt-2 max-w-sm text-xs md:text-sm leading-relaxed text-muted">
        {query
